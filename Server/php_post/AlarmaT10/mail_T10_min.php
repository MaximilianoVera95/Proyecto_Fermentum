...
$tanque1 = mysqli_query($conecta,"SELECT * FROM `tanque10`");

while($row = mysqli_fetch_array($tanque1)){
    $serie1 = $row['serie'];
    $min1 = $row['minimo'];
    $sensor1 = $row['SensorT10'];
    $max1 = $row['maximo'];
}
/////////////////////////////////////////////
...
try {
    ...
    $mail->Subject = 'Tanque 10: ALERTA MIN!!!';
    $mail->Body    = "El día $t1, la temperatura del sensor S1=$sensor1 °C del $serie1 estuvo por debajo del rango mínimo establecido Mín=$min1 °C. Nota: Recuerde volver a activar la alarma!!!";
