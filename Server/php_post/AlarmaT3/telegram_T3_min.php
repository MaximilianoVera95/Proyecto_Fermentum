...
$datos = [
    ...
    'text' => "El dia:$t1 la temperatura del sensor S1:$sensor3 °C del $serie3 estuvo por debajo del rango minimo establecido Min:$min3 °C. Nota: Recuerde volver a activar la alarma!!!",
