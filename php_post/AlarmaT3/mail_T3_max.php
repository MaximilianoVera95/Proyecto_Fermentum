...
try {
    ...
    $mail->Subject = 'Tanque 3: ALERTA MAX!!!';
    $mail->Body    = "El día $t1, la temperatura del sensor S1=$sensor3 °C del $serie3 superó el rango máximo establecido Máx=$max3 °C. Nota: Recuerde volver a activar la alarma!!!";
