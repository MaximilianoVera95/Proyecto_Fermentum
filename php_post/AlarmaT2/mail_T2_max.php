...
try {
    ...
    $mail->Subject = 'Tanque 2: ALERTA MAX!!!';
    $mail->Body    = "El día $t1, la temperatura del sensor S1=$sensor2 °C del $serie2 superó el rango máximo establecido Máx=$max2 °C. Nota: Recuerde volver a activar la alarma!!!";
