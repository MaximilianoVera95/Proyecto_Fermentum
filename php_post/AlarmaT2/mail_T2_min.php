...
try {
    ...
    $mail->Subject = 'Tanque 2: ALERTA MIN!!!';
    $mail->Body    = "El día $t1, la temperatura del sensor S1=$sensor2 °C del $serie2 estuvo por debajo del rango mínimo establecido Mín=$min2 °C. Nota: Recuerde volver a activar la alarma!!!";
