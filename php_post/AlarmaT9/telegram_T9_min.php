...
$tanque = mysqli_query($conecta,"SELECT * FROM `tanque9`");
...
$datos = [
    ...
    'text' => "El dia:$t1 la temperatura del sensor S1:$sensor °C del $serie estuvo por debajo del rango minimo establecido Min:$min °C. Nota: Recuerde volver a activar la alarma!!!",
